defmodule Tutorial.LibraryTest do
  ...
  describe "books" do
    ...
    import Tutorial.LibraryFixtures

    @invalid_attrs %{category: nil, title: nil}
    ...
    test "create_book/1 with valid data creates a book" do
      valid_attrs = %{category: "some category", title: "some title"}
    ...
    test "update_book/2 with valid data updates the book" do
      book = book_fixture()
      update_attrs = %{category: "some updated category", title: "some updated title"}
